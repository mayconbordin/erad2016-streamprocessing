...
import br.ufrgs.inf.gppd.utils.Triple;
    ...
    public void execute(Tuple input, BasicOutputCollector collector) {
        ...
        if (input.contains("pos_score")) {
            ...
            if (tweets.containsKey(id)) {
                Triple<String, Float, String> triple = tweets.get(id);
                ...
                tweets.put(id, new Triple<String, Float, String>("pos", pos, text));
            }
        }
            ...
            if (tweets.containsKey(id)) {
                ...
                tweets.put(id, new Triple<String, Float, String>("neg", neg, text));
            }
        }
